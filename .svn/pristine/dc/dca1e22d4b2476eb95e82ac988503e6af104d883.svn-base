...
/// Do not touch this directly, instead, use axisMinimum. This is automatically calculated to represent the real min value, and is used when calculating the effective minimum.
@property (nonatomic) double _axisMinimum;

/// Do not touch this directly, instead, use axisMaximum. This is automatically calculated to represent the real max value, and is used when calculating the effective maximum.
...
/// \returns  <code>true
/// </code> if the DataSet values should be drawn, <code>false
/// </code> if not.
...
/// Moves the left side of the current viewport to the specified x-value. This also refreshes the chart by calling setNeedsDisplay().
...
/// This will move the left side of the current viewport to the specified x-value on the x-axis, and center the viewport to the specified y-value on the y-axis. This also refreshes the chart by calling setNeedsDisplay().
///
/// \param xValue 
///
/// \param yValue 
...
/// This will move the center of the current viewport to the specified x-value and y-value. This also refreshes the chart by calling setNeedsDisplay().
///
/// \param xValue 
///
/// \param yValue 
...
- (double)getAxisRange:(enum AxisDependency)axis;
...
///
/// \returns  <code>true
/// </code> if zooming via double-tap is enabled <code>false
/// </code> ifnot.
...
///
/// \returns  <code>true
/// </code> if drawing the grid background is enabled, <code>false
/// </code> ifnot.
...
///
/// \returns  <code>true
/// </code> if drawing the borders rectangle is enabled, <code>false
/// </code> ifnot.
...
/// </code>.
- (CGPoint)valueForTouchPointWithPt:(CGPoint)pt axis:(enum AxisDependency)axis;

/// Transforms the given chart values into pixels. This is the opposite method to valueForTouchPoint(...).
...
///
/// \returns  <code>true
/// </code> if pinch-zoom is enabled, <code>false
/// </code> ifnot
...
/// The X axis renderer. This is a read-write property so you can set your own custom renderer here. default: An instance of XAxisRenderer
///
/// \returns  The current set X axis renderer
@property (nonatomic, strong) ChartXAxisRenderer * _Nonnull xAxisRenderer;

/// The left Y axis renderer. This is a read-write property so you can set your own custom renderer here. default: An instance of YAxisRenderer
///
/// \returns  The current set left Y axis renderer
@property (nonatomic, strong) ChartYAxisRenderer * _Nonnull leftYAxisRenderer;

/// The right Y axis renderer. This is a read-write property so you can set your own custom renderer here. default: An instance of YAxisRenderer
///
...
/// \returns  <code>true
/// </code> if either the left or the right or both axes are inverted.
...
///
/// \returns  <code>true
/// </code> if auto scaling on the y axis is enabled.
...
/// Adds half of the bar width to each side of the x-axis range in order to allow the bars of the barchart to be fully displayed. default: false
@property (nonatomic) BOOL fitBars;

/// Set this to true to make the highlight operation full-bar oriented, false to make it highlight single values (relevant only for stacked). If enabled, highlighting operations will highlight the whole bar, even if only a single stack entry was tapped.
@property (nonatomic) BOOL highlightFullBarEnabled;

/// \returns  <code>true
/// </code> the highlight is be full-bar oriented, <code>false
/// </code> ifsingle-value
@property (nonatomic, readonly) BOOL isHighlightFullBarEnabled;
@property (nonatomic, readonly, strong) BarChartData * _Nullable barData;

/// \returns  <code>true
/// </code> if drawing values above bars is enabled, <code>false
/// </code> ifnot
@property (nonatomic, readonly) BOOL isDrawValueAboveBarEnabled;

/// \returns  <code>true
/// </code> if drawing shadows (maxvalue) for each bar is enabled, <code>false
/// </code> ifnot
@property (nonatomic, readonly) BOOL isDrawBarShadowEnabled;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
- (ChartHighlight * _Nullable)buildHighlightWithDataSet:(id <IChartDataSet> _Nonnull)set dataSetIndex:(NSInteger)dataSetIndex xValue:(double)xValue rounding:(enum ChartDataSetRounding)rounding;
...
- (CGFloat)getMinimumDistance:(NSArray<ChartHighlight *> * _Nonnull)closestValues y:(CGFloat)y axis:(enum AxisDependency)axis;
...
+ (ChartDefaultFillFormatter * _Nullable)withBlock:(CGFloat (^ _Nullable)(id <ILineChartDataSet> _Nonnull, id <LineChartDataProvider> _Nonnull))block;
- (CGFloat)getFillLinePositionWithDataSet:(id <ILineChartDataSet> _Nonnull)dataSet dataProvider:(id <LineChartDataProvider> _Nonnull)dataProvider;
@end
...
/// \returns  <code>true
/// </code> if drawing circles for this DataSet is enabled, <code>false
/// </code> ifnot
...
/// \returns  <code>true
/// </code> if drawing the circle-holes is enabled, <code>false
/// </code> ifnot.
...
/// \returns  Color for the hole in the shape. Setting to <code>nil
/// </code> will behave as transparent.
/// <em>default</em>: nil
...
- (NSArray<ChartHighlight *> * _Nonnull)getHighlightsWithIndex:(NSInteger)index;
- (nonnull instancetype)initWithChart:(id <ChartDataProvider> _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The radius of the hole in the shape (applies to Square, Circle and Triangle) default: 0.0
...
/// Sets the ScatterShape this DataSet should be drawn with. This will search for an available IShapeRenderer and set this renderer for the DataSet
- (void)setScatterShape:(enum ScatterShape)shape;

/// The IShapeRenderer responsible for rendering this DataSet. This can also be used to set a custom IShapeRenderer aside from the default ones. default: SquareShapeRenderer
